...
const ApproachSR = (props) => {
    console.log(props.pristup)
  return (
    <div
      className="row"
      style={{
    ...
    >
      {props.pristup.our_approach_repeater.map((val, i) => (
        <div className="col-xl-4 col-lg-6" key={i}>
          ...
          >
            ...
            >
              <div className="ptf-approach-box__subtitle">{val.number}</div>
